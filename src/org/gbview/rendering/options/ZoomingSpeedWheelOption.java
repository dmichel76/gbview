 ...
 */
public class ZoomingSpeedWheelOption implements Options
{

    private static String OPTION_NAME = "rendering.zooming.speed.wheel";
    private static float DEFAULT = 0.1f;

    private Preferences preferences;

    public ZoomingSpeedWheelOption(Preferences preferences)
    {
